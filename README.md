# genpark-multi-token-speculative-fim-code-generator-skill
...
> **GenPark AI Agent Skill** -- Multi-token speculative FIM code generator & syntax verifier (DeepSeek-Coder V2 style)
